...
One of the main goals in the topic is data mapping algorithm of the graphs. Current section covers the nature and structure of the input data. Also describes the work of the sub-graph extraction algorithm.
