...
More complex graph with additional properties and its visualization produced by yEd graph editor is in the~\ref{sec:appendix_A} and the visualization of this graph showed on the Figure~\ref{fig:yed_graph_vis}
